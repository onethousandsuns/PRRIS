...
{
    public class Discount_7 : BaseDiscount
    {
        public Discount_7( decimal value, string name ) 
            : base( value, name )
        {
        }
        ...
        {
            var products = cartHandler.GetSpecificAmountOfProducts(5, new List<ProductKind>
            {
                ProductKind.A,
                ProductKind.C
            });
