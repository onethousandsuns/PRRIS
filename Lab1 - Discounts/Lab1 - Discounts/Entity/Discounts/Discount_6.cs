...
{
    public class Discount_6 : BaseDiscount
    {
        public Discount_6( decimal value, string name ) 
            : base( value, name )
        {
        }
        ...
        {
            var products = cartHandler.GetSpecificAmountOfProducts(4, new List<ProductKind>
            {
                ProductKind.A,
                ProductKind.C
            });
